from rovarsprak.core.filehandler import write_file
from rovarsprak.config import OUTPUT_DIR
from rovarsprak.utils.logger import logger
from rovarsprak.core.language import is_vokal, is_konsonant  # om du använder dem
from rovarsprak.core.filehandler import list_input_files
import time
import random
from rovarsprak.core.hacker_mode import color as hcol

# färger kan importeras här om du vill använda dem i prompts
from rovarsprak.ui.normal.menu_colors import color, N_RED, N_YELLOW
from rovarsprak.core.hacker_mode import color as hcol
